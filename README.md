...
[![GitHub license](https://img.shields.io/github/license/jamesEdward/Portfolio?style=flat-square)](LICENSE)
...
```bash
git clone https://github.com/James-Edward-Ntigwimbugwa/Portfolio
```
